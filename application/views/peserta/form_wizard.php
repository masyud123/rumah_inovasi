                        ...
                        <div class="form-group " style="position: static;">
                                ...
                                //                Aksi Delete
                                    ...
                                    <tr>
                                       ...
                                       <td><input id="email_ketua"  type="email" name="email_ketua" style="width: 100%;background:whitesmoke;" class="form-control "></input></td>
                                    </tr>
                                    <tr>
                                       <td width="25%"><h5 style="margin-top:6px;"><strong>No. HP/WA</strong></h5></td>
                                       <td><input id="no_hp" type="text" name="no_hp" style="width: 100%;background:whitesmoke;" class="form-control "></input></td>
                                    </tr>
                                    <tr>
                                       <td width="25%"><h5 style="margin-top:6px;"><strong>Alamat Ketua</strong></h5></td>
                                       <td><textarea id="alamat_ketua" type="text" name="alamat_ketua" style="width: 100%;background:whitesmoke; height:10 0px;" class="form-control"></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                       ...
                                       <td><input id="ktp" type="file" name="ktp" style="height: 44px; width: 100%;background:whitesmoke;" class="form-control " accept="image/png,image/jpeg,image/jpg,application/pdf,"></td>
                                    </tr>
                                </table>
                            ...
                            <table class="table table-borderless table-responsive" style="display: none; justify-content: center; width: 70%;" id="target3_3">
                                <tr>
                                    ...
                                    <td><input type="file" name="proposal" id="surat" style="width: 100%; height:45px;" class="form-control" accept="application/pdf," ></td>
                                </tr>
                                <tr>
                                    <td width="23%"><h5 style="margin-top:6px;"><strong>Dokumen</strong></h5></td>
                                    <td><input type="file" name="jurnal" id="jurnal" style="width: 100%; height:45px;" class="form-control"  accept="application/pdf,"></td>
                                </tr>
                                <tr>
                                    <td width="23%"><h5 style="margin-top:6px;"><strong>Gambar</strong></h5></td>
                                    <td><input type="file" name="gambar" id="gambar" style="width: 100%; height:45px;" class="form-control"  accept="image/png,image/jpeg,image/jpg,application/pdf,"></td>
                                </tr>
                                <tr>
