...
<html><head>
	...
	<table style="width: 100%;" class="table-transparent">
      <tr>
        <td align="center">
          <span style="line-height: 10%; font-weight: bold;font-size: 18pt; font-family: Arial, Helvetica, sans-serif;">
            <p>BERITA ACARA</p>
    ...
    <table style="margin-left:15pt;margin-right: 15pt;" class="table-transparent">
    	<tr>
    		<td>
    			<p style="text-indent: 50pt;text-align: justify;font-family:Arial, Helvetica, sans-serif;">Pada hari ini, <?php setlocale(LC_ALL, 'id_ID');
															 ...
															 <?php endforeach;?>
															   ...
															   <p style="text-indent: 50pt;text-align: justify;font-family:Arial, Helvetica, sans-serif;">Dari tahapan verifikasi Proposal, Video dan Demo Peragaan Karya Inovasi dari masing masing peserta,  Tim Penilai menetapkan peserta yang lolos sebagai berikut :</p>
															   <p style="font-size:16pt;font-weight: bold;font-family:Arial, Helvetica, sans-serif;"><u>KATEGORI UMUM :</u></p>
    		</td>
    	</tr>
    </table>
	<table class="table" style="width: 100%;margin-left: 15pt;margin-right: 15pt;margin-bottom: 10pt;">
		<tr>
