<div class="container-fluid">
  <a href="<?php echo base_url('admin/data_verifikasi/umum') ?>"><div class="btn btn-success mb-2">Kategori Umum</div></a>
  <a href="<?php echo base_url('admin/data_verifikasi/pelajar') ?>"><div class="btn btn-secondary active mb-2">Kategori Pelajar</div></a>
