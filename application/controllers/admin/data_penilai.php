...
class Data_penilai extends CI_Controller{
	...
	public function tambah_penilai()
	{
		...
		if ( $cek_user > 0 ) {
		$this->session->set_flashdata('message1','<div class="alert alert-danger alert-dismissible fade show" style="width: 80%;" role="alert"><i class="fas fa-check-circle"></i>
		...
		$this->session->set_flashdata('message1','<div class="alert alert-success alert-dismissible fade show" style="width: 80%;" role="alert"><i class="fas fa-check-circle"></i>
	...
	public function hapus ()
	{
        ...
        if ($cek_data > 0) {
	        $this->session->set_flashdata('hapus_penilai', '<div class="alert alert-danger alert-dismissible fade show" style="width:80%;" role="alert"><i class="fas fa-info-circle"></i>
